 ...
 */
public class MyArrayAdapter extends ArrayAdapter<DataFieldRecognition> {

    private final Activity context;
    private final List<DataFieldRecognition> list;

    public MyArrayAdapter(Activity context, List<DataFieldRecognition> list) {
